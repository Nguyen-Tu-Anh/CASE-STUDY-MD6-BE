...
import com.codegym.socialbook.be.security.pack.dto.request.SignUpForm;
import com.codegym.socialbook.be.security.pack.dto.response.JwtResponse;
...
import com.codegym.socialbook.be.security.pack.security.jwt.JwtProvider;
...
import com.codegym.socialbook.be.security.pack.security.jwt.JwtTokenFilter;
import com.codegym.socialbook.be.security.pack.security.userpincal.UserPrinciple;
        ...
        strRoles.forEach(role -> {
            switch (role) {
                case "admin":
                    ...
                    break;
                case "sp":
                    Role spRole = roleService.findByName(RoleName.SP).orElseThrow(() -> new RuntimeException("Role not found"));
                    roles.add(spRole);
                    break;
                default:
